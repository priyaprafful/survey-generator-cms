<template>
  <svg
    id="f3eed9ab-b3c9-460a-88ab-1023f1e90328"
    data-name="Layer 1"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 308.19 244.73"
  >
    ...
    <path
      d="M410.75,743.34c-1,3.43-2,6.87-3,10.29a3.79,3.79,0,0,1-5.46,2.31,91.27,91.27,0,0,0-13-6.5c-3.7-1.53-1-7.2,2.56-6.28v0a62.37,62.37,0,0,1,7.68,2.94C394,732.24,382,723.23,367.61,718.8c-1.1-.33-1-2.16.26-2.07,15.51,1.12,28.71,12.58,35,26.53.18-.62.35-1.24.52-1.86C404.71,736.67,412.14,738.63,410.75,743.34Z"
      transform="translate(-266.58 -716.72)"
      style="fill: #1c1c1b;"
    />
  </svg>
